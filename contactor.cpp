...
// add two bounds to the element
 new Terminal (0, 0, Terminal :: North, this, scene);
 new Terminal (0, 60, Terminal :: South, this, scene);
}

 /**
@return The current number of terminals of the element
 */
 int Contactor :: nbTerms () const {
 return (2);
}
